...
def GetZeroPolicy(name: str)->URCIPolicyObsEhr03:
...
def GetSinPolicy(name: str)->URCIPolicyObsEhr03:
    # Usage: $EVALMJC=_external_zero
    import numpy as np
...
def GetExternalPolicy(description: str, config: CfgType)->URCIPolicyObsEhr03:
