...
from humanoidverse.deploy import URCIRobotEhr03, URCIPolicyObsEhr03, CfgTypeEhr03
...
def main(override_config: OmegaConf):
    ...
    def setup_simulator(simulator_type):    
        ...
        if simulator_type == 'real':
            ...
            from humanoidverse.deploy.mujoco_ehr03 import MujocoRobot
    ...
    def setup_logging2(config: CfgTypeEhr03):
    ...
    def load_policy(config: CfgTypeEhr03, checkpoint: Path):
    ...
    def get_policy_obs(config: CfgTypeEhr03)->URCIPolicyObsEhr03:
    ...
    def load_raw_ckpt_config(path: str, override_config: CfgTypeEhr03):
            
        
        
        if path.startswith('_external'):
            config_path = Path("humanoidverse/config/deploy/external_ehr03.yaml")
    ...
    def check_compatibility_config_robot(main_cfg: CfgTypeEhr03, sub_cfg: CfgTypeEhr03):
        """
    ...
    def check_compatibility_config_obs(main_cfg: CfgTypeEhr03, sub_cfg: CfgTypeEhr03):
    ...
    single_policy_config = OmegaConf.load("humanoidverse/config/deploy/single_ehr03.yaml")
    multiple_policy_config = OmegaConf.merge(
        single_policy_config,
        OmegaConf.load("humanoidverse/config/deploy/multiple_ehr03.yaml"),
    )
    ...
    robot:URCIRobotEhr03 = RobotCls(main_cfg)
