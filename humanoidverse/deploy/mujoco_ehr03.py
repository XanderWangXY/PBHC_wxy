...
import torch
from humanoidverse.deploy import URCIRobotEhr03
...
class MujocoRobot(URCIRobotEhr03, MViewerPlugin):
    REAL=False
    ...
    def ApplyAction(self, action): 
        ...
        URCIRobotEhr03.ApplyAction(self, action)
