...
_EHR03_KEYPOINT_TO_JOINT = {
    "Pelvis": {"name": "base_link", "weight": 5.0},
    # "Head": {"name": "head", "weight": 5.0},
    # Legs.
    "L_Hip": {"name": "l_leg_l3", "weight": 1.0},
    "R_Hip": {"name": "r_leg_l3", "weight": 1.0},
    "L_Knee": {"name": "l_leg_l4", "weight": 1.0},
    "R_Knee": {"name": "r_leg_l4", "weight": 1.0},
    "L_Ankle": {"name": "l_leg_l6", "weight": 1.0},
    "R_Ankle": {"name": "r_leg_l6", "weight": 1.0},
    # Arms.
    "L_Elbow": {"name": "l_arm_l4", "weight": 1.0},
    "R_Elbow": {"name": "r_arm_l4", "weight": 1.0},
    "L_Wrist": {"name": "l_arm_l6", "weight": 1.0},
    "R_Wrist": {"name": "r_arm_l6", "weight": 1.0},
    "L_Shoulder": {"name": "l_arm_l1", "weight": 3.0},
    "R_Shoulder": {"name": "r_arm_l1", "weight": 3.0},

    # toe
    "L_Toe": {"name": "l_foot", "weight": 1.0},
    "R_Toe": {"name": "r_foot", "weight": 1.0},
    # torso
    # "Torso": {"name": "torso_link", "weight": 3.0},
...
_KEYPOINT_TO_JOINT_MAP = {
    ...
    "ehr03": _EHR03_KEYPOINT_TO_JOINT,
}
...
def construct_model(robot_name: str, keypoint_names: Sequence[str]):
    ...
    root.visual.quality.shadowsize = "256"
    ...
    elif robot_name == "ehr03":
        humanoid_mjcf = mjcf.from_path("../description/robots/ehr03/urdf/ehr03_simplifed_with_foot.xml")
    else:
...
def create_robot_motion(
    ...
    if robot_type == 'ehr03' : from retargeting.torch_humanoid_batch_ehr03 import Humanoid_Batch
